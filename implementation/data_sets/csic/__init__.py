...
from ..base import group_requests
...
SELECTED_ENDPOINT_LIST = (                              # see comment in function 'print_info'
    ...
    'GET http://localhost:8080/tienda1/publico/autenticar.jsp',
    'POST http://localhost:8080/tienda1/publico/autenticar.jsp',
    'GET http://localhost:8080/tienda1/publico/caracteristicas.jsp',
    'POST http://localhost:8080/tienda1/publico/caracteristicas.jsp',
    'GET http://localhost:8080/tienda1/publico/entrar.jsp',
    'POST http://localhost:8080/tienda1/publico/entrar.jsp',
    'GET http://localhost:8080/tienda1/publico/pagar.jsp',
    ...
    'GET http://localhost:8080/tienda1/publico/vaciar.jsp',
...
def print_info():
    ...
    -------------------------------------------------------------------------------------------
     883 | GET  http://localhost:8080/tienda1/miembros/editar.jsp         |  2,000 |     1,362
     884 | POST http://localhost:8080/tienda1/miembros/editar.jsp         |  2,000 |     1,362
    1217 | GET  http://localhost:8080/tienda1/publico/anadir.jsp          |  2,000 |     1,380
    1218 | POST http://localhost:8080/tienda1/publico/anadir.jsp          |  2,000 |     1,380
    1285 | GET  http://localhost:8080/tienda1/publico/autenticar.jsp      |  2,000 |     1,361
    1286 | POST http://localhost:8080/tienda1/publico/autenticar.jsp      |  2,000 |     1,361
    1330 | GET  http://localhost:8080/tienda1/publico/caracteristicas.jsp |  2,000 |       954
    1331 | POST http://localhost:8080/tienda1/publico/caracteristicas.jsp |  2,000 |       954
    1407 | GET  http://localhost:8080/tienda1/publico/entrar.jsp          |  2,000 |       897
    1408 | POST http://localhost:8080/tienda1/publico/entrar.jsp          |  2,000 |       897
    1484 | GET  http://localhost:8080/tienda1/publico/pagar.jsp           |  2,000 |     1,343
    1485 | POST http://localhost:8080/tienda1/publico/pagar.jsp           |  2,000 |     1,343
    1552 | GET  http://localhost:8080/tienda1/publico/registro.jsp        |  2,000 |     1,364
    1553 | POST http://localhost:8080/tienda1/publico/registro.jsp        |  2,000 |     1,364
    1597 | GET  http://localhost:8080/tienda1/publico/vaciar.jsp          |  2,000 |       919
    1598 | POST http://localhost:8080/tienda1/publico/vaciar.jsp          |  2,000 |       919
    -------------------------------------------------------------------------------------------
    ...
    for i, (k, v_list) in enumerate(sorted(d1.items())):
        ...
        if qty_normal > 100 and qty_anomalous > 100:
            ...
            url, method = k.split()
            print('{:4d} | {:4s} {:57s} | {:6,d} | {:9,d}'.format(
